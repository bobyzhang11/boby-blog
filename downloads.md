...
<h2 class="text-4xl font-bold mb-2">资料下载</h2>
<p class="text-gray-500 mb-10">部分文档、模板及参考资料</p>

<div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
  <a href="/downloads/PRD-template.docx" class="bg-white rounded-2xl p-6 shadow-sm card-hover flex items-center gap-4 no-underline">
